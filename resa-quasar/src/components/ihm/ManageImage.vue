<template>
  <div class="row">
    <div class=" col col-6 q-pr-xl "> <q-uploader color="secondary" v-model="selectedImage"
        label="Nouvelle image (max 2k)" class="q-pt-md" @rejected="onRejected" :max-file-size=K_size_avatar
        accept=".jpeg,.jpg,.png,.gif" :url="getUrl" @added="ajoutFichier" style="max-width: 300px"
        @removed="deleteFile" />
    </div>
    <div class="text-center q-pl-xl col col-6">
      <q-img class="col-6 img-size" :src="modelValue">
...
const props = defineProps(['modelValue', 'path', 'selectedFile'])
//
